...
define(["underscore", "org/forgerock/openidm/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager"], function (_, constants, EventManager) {
    var obj = [{
        ...
        description: "",
        override: true,
        dependencies: ["org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/delegates/MaintenanceDelegate", "org/forgerock/openidm/ui/admin/delegates/SchedulerDelegate", "org/forgerock/commons/ui/common/components/Navigation", "config/routes/AdminRoutesConfig", "org/forgerock/commons/ui/common/util/URIUtils"],
        processDescription: function processDescription(event, Router, Constants, MaintenanceDelegate, SchedulerDelegate, Navigation, AdminRoutesConfig, URIUtils) {
        ...
        processDescription: function processDescription(event, $, Navigation, ConfigDelegate, Configuration) {
            ...
            $.when(ConfigDelegate.readEntity("managed"), ConfigDelegate.readEntity("ui/configuration"), ConfigDelegate.readEntity("ui/dashboard")).then(function (managedConfig, uiConfig, dashboardConfig) {
