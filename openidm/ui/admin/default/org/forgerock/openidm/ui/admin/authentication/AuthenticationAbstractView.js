...
define(["jquery", "lodash", "jsonEditor", "form2js", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/admin/util/InlineScriptEditor", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/ModuleLoader"], function ($, _, JSONEditor, Form2js, AdminAbstractView, InlineScriptEditor, ConfigDelegate, EventManager, Constants, ModuleLoader) {
    ...
    var authenticationDataChanges = {},
        ...
        getCustomPropertiesList: function getCustomPropertiesList(knownProperties, configProperties) {
            ...
            var customPropertyKeys = _.filter(_.keys(configProperties), function (key) {
        ...
        initGroupMembershipJSONEditor: function initGroupMembershipJSONEditor(config) {
            ...
            var schema = {
                ...
                "type": "array",
                "default": [{ "roleName": "openidm-admin", "groupMapping": [] }],
                "items": {
                    "type": "object",
        ...
        getAMModuleIndex: function getAMModuleIndex(allAuthModules) {
            return _.findIndex(allAuthModules, function (module) {
                ...
                var resolverNameMatch = _.get(module.properties, "idpConfig.provider") === "OPENAM";
