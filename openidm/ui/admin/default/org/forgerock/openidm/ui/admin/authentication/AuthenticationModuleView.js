...
define(["jquery", "underscore", "backbone", "backgrid", "handlebars", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/authentication/AuthenticationAbstractView", "org/forgerock/openidm/ui/admin/authentication/AuthenticationModuleDialogView", "org/forgerock/openidm/ui/common/util/BackgridUtils"], function ($, _, Backbone, Backgrid, Handlebars, Constants, AuthenticationAbstractView, AuthenticationModuleDialogView, BackgridUtils) {
    ...
    var AuthenticationModuleView = AuthenticationAbstractView.extend({
        ...
        data: {
            module_types: [{ "key": "STATIC_USER", "value": "" }, { "key": "CLIENT_CERT", "value": "" }, { "key": "IWA", "value": "" }, { "key": "MANAGED_USER", "value": "" }, { "key": "OPENAM_SESSION", "value": "" }, { "key": "INTERNAL_USER", "value": "" }, { "key": "SOCIAL_PROVIDERS", "value": "" }, { "key": "PASSTHROUGH", "value": "" }, { "key": "TRUSTED_ATTRIBUTE", "value": "" }],
