...
define(["jquery", "underscore", "backbone", "bootstrap", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openidm/ui/admin/delegates/ConnectorDelegate", "org/forgerock/openidm/ui/admin/util/ConnectorUtils", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "backgrid", "org/forgerock/openidm/ui/common/util/BackgridUtils", "org/forgerock/commons/ui/common/util/UIUtils"], function ($, _, Backbone, bootstrap, AdminAbstractView, eventManager, constants, router, ConnectorDelegate, connectorUtils, ConfigDelegate, Backgrid, BackgridUtils, UIUtils) {
        ...
        deleteConnections: function deleteConnections(event) {
            ...
            connectorUtils.deleteConnector(connectorName, connectorPath, function () {
                ...
                if (_this2.$el.find(".backgrid tbody tr").length === 0) {
                    _this2.$el.find(".backgrid tbody").append("<tr class='empty'><td colspan='3'>" + $.t("templates.connector.noResourceTitle") + "</td></tr>");
                }
            });
        },
