...
define(["jquery", "underscore", "bootstrap", "handlebars", "dimple", "form2js", "org/forgerock/openidm/ui/common/dashboard/widgets/AbstractWidget", "org/forgerock/openidm/ui/admin/delegates/ReconDelegate", "org/forgerock/commons/ui/common/util/DateUtil", "org/forgerock/openidm/ui/admin/delegates/SyncDelegate", "moment"], function ($, _, bootstrap, handlebars, dimple, form2js, AbstractWidget, ReconDelegate, DateUtil, SyncDelegate, moment) {
    var widgetInstance = {},
        ...
        reconResultRender: function reconResultRender(mapping, recon, callback) {
            var goodColor = "#70a796";
            var warningColor = "#e6bf24";
            var dangerColor = "#ca3127";
        ...
        mappingSelected: function mappingSelected(event) {
