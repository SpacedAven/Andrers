...
define(["jquery", "underscore", "form2js", "handlebars", "trumbowyg", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/openidm/ui/admin/util/AdminUtils", "libs/codemirror/lib/codemirror", "libs/codemirror/mode/xml/xml", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/commons/ui/common/components/ChangesPending", "org/forgerock/openidm/ui/common/delegates/ResourceDelegate", "bootstrap-dialog"], function ($, _, form2js, Handlebars, trumbowyg, AdminAbstractView, eventManager, Constants, ConfigDelegate, AdminUtils, codeMirror, xmlMode, UIUtils, ChangesPending, resourceDelegate, BootstrapDialog) {
            ...
            $.when(configReadPromise, extensionPartialPromise, schemaPromise, sampleDataPromise).then(function (config, partial, schema, sampleData) {
                ...
                _this.parentRender(function () {
                    _this.model.changesModule = ChangesPending.watchChanges({
                        ...
                        undo: true,
                        watchedObj: _.clone(_this.data.config, true)
                    });
