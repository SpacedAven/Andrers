...
define(["jquery", "lodash", "handlebars", "backbone", "backgrid", "bootstrap-dialog", "org/forgerock/openidm/ui/common/util/BackgridUtils", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/openidm/ui/admin/managed/schema/dataTypes/EditResourceCollectionDialog", "org/forgerock/openidm/ui/admin/managed/schema/util/RelationshipUtils", "org/forgerock/openidm/ui/admin/managed/schema/util/SchemaUtils", "org/forgerock/openidm/ui/admin/util/AdminUtils"], function ($, _, Handlebars, Backbone, Backgrid, BootstrapDialog, BackgridUtils, AdminAbstractView, ConfigDelegate, EditResourceCollectionDialog, RelationshipUtils, SchemaUtils, AdminUtils) {
    ...
    var RelationshipTypeView = AdminAbstractView.extend({
         ...
         * @param {DomEvent}
         */
        addResource: function addResource(event) {
            var _this6 = this;
            ...
            this.fireResourceModal({ managedObjects: managedObjects }, function (resource) {
                ...
                if (RelationshipUtils.isReverseRelationship(_this6.currentRelationshipItem("property"))) {
                    ...
                    if (reverseRelationshipItems.length) {
                        ...
                        _this6.model.updatedRelationship[_this6.model.reverserPropertyName] = reverseRelationshipItems.concat(resourceRelationshipItem);
                    }
                }
                _this6.makeChanges();
                _this6.render();
        ...
        configureReverseRelationship: function configureReverseRelationship(reverseSideType, cb) {
            ...
            this.fireResourceModal({ path: path, icon: icon, reverseRelationship: { resources: resources } }, function (data) {
                var _this8$model$updatedR;
                ...
                _this8.model.updatedRelationship = (_this8$model$updatedR = {}, _defineProperty(_this8$model$updatedR, _this8.model.propertyName, propertyItems), _defineProperty(_this8$model$updatedR, data.propertyName, reverseItems), _this8$model$updatedR);
                _this8.makeChanges();
                _this8.render(cb);
            });
        },
        ...
        fireResourceModal: function fireResourceModal(options, dataHandler) {
            ...
            if (_.isEmpty(options.path)) {
                ...
                if (!_.isEmpty(options.reverseRelationship)) {
         ...
         */
        generateConfigChanges: function generateConfigChanges() {
            var _this9 = this;

            var managedConfig = _.cloneDeep(this.model.managedConfig),
                originalRelationship = _(_.cloneDeep(this.model.relationship)).values().flattenDeep().map(function (item) {
                return _.set(item, "version", "original");
            }).value(),
                updatedRelationship = _(_.cloneDeep(this.model.updatedRelationship)).values().flattenDeep().map(function (item) {
            ...
            .pairs().value().reduce(function (configChanges, objDiff) {
                ...
                _.forIn(propertyDict, function (versions, propertyName) {
                    ...
                    if (originalProperty) {
                        if (updatedProperty) {
                            ...
                            if (!propertiesEqual) {
                                ...
                                configChanges.insertions.push({ objectName: objectName, propertyName: _propertyName, property: property });
                            }
                        ...
                        var _propertyName2 = updated.propertyName,
                            _property = updated.property;

                        configChanges.insertions.push({ objectName: objectName, propertyName: _propertyName2, property: _property });
                    }
                });
        ...
        getValue: function getValue() {
            return this.applyConfigChanges(this.model.managedConfig, this.generateConfigChanges());
        },
        ...
        loadPropertiesGrid: function loadPropertiesGrid() {
            ...
            makeSortable = function makeSortable() {
                BackgridUtils.sortable({
                    "containers": [_this10.$el.find(".refPropertiesList tbody")[0]],
                    "rows": _.clone(_this10.model.refPropertiesCollection.toJSON(), true)
