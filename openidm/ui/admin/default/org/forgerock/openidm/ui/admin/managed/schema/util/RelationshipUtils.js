...
define(["jquery", "lodash", "backbone", "org/forgerock/openidm/ui/admin/util/AdminUtils"], function ($, _, Backbone, AdminUtils) {
    var obj = {};
    ...
    obj.otherProperties = ["description", "title", "viewable", "searchable", "userEditable", "policies", "returnByDefault", "minLength", "pattern"];
    ...
    obj.hasRelationshipType = function (objectProperty) {
        return _.matchesProperty("type", "relationship")(objectProperty);
    };
     ...
     * @param {RelationshipProperty} relationshipProperty
     * @param {String} propertyName
     * @param {Object|Array|String|Boolean} propertyValue -- value that you want to set
    ...
    obj.getDefaultDisplayProperty = function (managedObject) {
        ...
        _.forEach(managedObject.schema.order, function (propName) {
            ...
            if (prop.type === "string" && prop.scope !== "private" && prop.viewable && !prop.ecryption && !prop.isVirtual) {
