...
define(["jquery", "underscore", "bootstrap", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openidm/ui/admin/delegates/ConnectorDelegate", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/util/ConnectorUtils", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/openidm/ui/admin/mapping/MapResourceView"], function ($, _, bootstrap, AdminAbstractView, eventManager, constants, router, ConnectorDelegate, uiUtils, connectorUtils, ConfigDelegate, MapResourceView) {
    ...
    var MappingAddView = AdminAbstractView.extend({
        ...
        render: function render(args, callback) {
            var connectorPromise, managedPromise, tempIconClass;
         ...
         */
        addResourceEvent: function addResourceEvent(event) {
         ...
         * @returns {*} Returns the correct connector or managed object details based on the URL arguments to allow for on load selection of a resource
         */
        addResourceMapping: function addResourceMapping(resourceType, resourceLocation, connectors, managedObjects) {
            var resourceData = null;
