...
define(["jquery", "lodash", "form2js", "handlebars", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/main/ValidatorsManager", "bootstrap-dialog"], function ($, _, form2js, handlebars, AbstractView, eventManager, constants, router, ConfigDelegate, ValidatorsManager, BootstrapDialog) {
    var MapResourceView = AbstractView.extend({
        ...
        partials: ["partials/mapping/_mapResourceDialog.html"],
        model: {
            sourceAdded: false,
            targetAdded: false,
            sourceDetails: null,
