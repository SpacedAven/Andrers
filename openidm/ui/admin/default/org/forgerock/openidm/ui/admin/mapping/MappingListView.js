...
define(["jquery", "underscore", "handlebars", "backbone", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/delegates/ReconDelegate", "org/forgerock/commons/ui/common/util/DateUtil", "org/forgerock/openidm/ui/admin/delegates/SyncDelegate", "org/forgerock/openidm/ui/admin/util/ConnectorUtils", "org/forgerock/commons/ui/common/util/UIUtils", "backgrid", "org/forgerock/openidm/ui/common/util/BackgridUtils", "org/forgerock/commons/ui/common/util/AutoScroll", "dragula", "org/forgerock/openidm/ui/admin/mapping/util/MappingUtils"], function ($, _, handlebars, Backbone, AdminAbstractView, eventManager, configDelegate, constants, reconDelegate, dateUtil, syncDelegate, connectorUtils, UIUtils, Backgrid, BackgridUtils, AutoScroll, dragula, mappingUtils) {
    ...
    var MappingListView = AdminAbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            $.when(syncConfig, managedPromise).then(function (sync, managedDetails) {
