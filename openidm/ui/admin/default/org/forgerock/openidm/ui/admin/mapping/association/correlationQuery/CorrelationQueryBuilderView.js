...
define(["jquery", "underscore", "handlebars", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/admin/util/InlineScriptEditor"], function ($, _, Handlebars, AdminAbstractView, InlineScriptEditor) {
    ...
    CorrelationQueryBuilderView = AdminAbstractView.extend({
        ...
        render: function render(args) {
            ...
            this.data.fieldNames = _.chain(this.data.fieldNames).unique().sortBy("name").value();
            ...
            this.parentRender(_.bind(function () {
                function emptyGroups(node) {
                    var returnVal = true,
                        arrayCheck = function arrayCheck(v) {
                        if (_.isObject(v)) {
        ...
        validLinkQualifier: function validLinkQualifier(linkQualifier) {
            if (linkQualifier.length > 0 && (this.model.edit || !this.model.edit && _.indexOf(this.model.linkQualifiers, linkQualifier) > -1)) {
                return true;
            } else {
                return false;
            }
        ...
        validate: function validate() {
            ...
            if ((this.$el.find("#scriptQueryRadio").prop("checked") && _.has(this.model, "scriptEditor") && this.model.scriptEditor.generateScript() !== null || this.$el.find("#expressionTreeQueryRadio").prop("checked") && this.$el.find(".expressionTree li[field]").length > 0) && this.validLinkQualifier(this.$el.find(".linkQualifier").val() || "")) {
        ...
        renderExpressionTree: function renderExpressionTree() {
            this.render({
        ...
        changeQueryType: function changeQueryType() {
        ...
        showExpressionMenu: function showExpressionMenu(e) {
            e.preventDefault();
        ...
        addExpressionField: function addExpressionField(e) {
        ...
        addExpressionGroup: function addExpressionGroup(e) {
            var node = this.getExpressionContext(e).current;
    ...
    Handlebars.registerHelper("expressionDisplay", function (rules, fieldNames, options) {
        ...
        _.each(rules, function (fields, type) {
            ...
            returnVal += expressionClosure({
                ...
                "filteredFieldNames": _.filter(fieldNames, function (f) {
                    return _.indexOf(fields, f) === -1;
                }),
                ...
                "expressionTree": _.map(fields, function (v) {
                    ...
                    return {
                        ...
                        "isObject": (typeof v === "undefined" ? "undefined" : _typeof(v)) === "object",
                        "isAny": (typeof v === "undefined" ? "undefined" : _typeof(v)) === "object" && _.has(v, "any"),
