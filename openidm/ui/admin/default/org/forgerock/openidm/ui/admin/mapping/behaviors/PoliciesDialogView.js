...
define(["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/util/InlineScriptEditor", "org/forgerock/openidm/ui/admin/mapping/util/LinkQualifierFilterEditor", "org/forgerock/openidm/ui/admin/util/WorkflowWidget", "bootstrap-dialog"], function ($, _, AbstractView, conf, uiUtils, InlineScriptEditor, LinkQualifierFilterEditor, WorkflowWidget, BootstrapDialog) {
    ...
    var PoliciesDialogView = AbstractView.extend({
        ...
        actionValidation: function actionValidation(id) {
            if (id === "workflowTab") {
        ...
        toggleActiveAlert: function toggleActiveAlert(show) {
            if (show) {
