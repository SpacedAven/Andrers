...
define(["jquery", "underscore", "handlebars", "backbone", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/mapping/util/MappingUtils", "org/forgerock/openidm/ui/common/delegates/ScriptDelegate", "org/forgerock/openidm/ui/admin/util/FilterEvaluator", "org/forgerock/openidm/ui/common/util/QueryFilterEditor", "org/forgerock/openidm/ui/admin/mapping/properties/AddPropertyMappingDialog", "org/forgerock/openidm/ui/admin/mapping/properties/EditPropertyMappingDialog", "backgrid", "org/forgerock/openidm/ui/common/util/BackgridUtils", "org/forgerock/commons/ui/common/util/UIUtils"], function ($, _, Handlebars, Backbone, AdminAbstractView, eventManager, conf, constants, mappingUtils, ScriptDelegate, FilterEvaluator, QueryFilterEditor, AddPropertyMappingDialog, EditPropertyMappingDialog, Backgrid, BackgridUtils, UIUtils) {
    ...
    var AttributesGridView = AdminAbstractView.extend({
        ...
        */
        ...
        saveMapping: function saveMapping(e) {
