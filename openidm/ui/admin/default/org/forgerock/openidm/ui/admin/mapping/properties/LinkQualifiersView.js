...
define(["jquery", "underscore", "org/forgerock/openidm/ui/admin/mapping/util/MappingAdminAbstractView", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/openidm/ui/admin/util/InlineScriptEditor", "org/forgerock/openidm/ui/common/delegates/ScriptDelegate", "org/forgerock/openidm/ui/admin/util/LinkQualifierUtils"], function ($, _, MappingAdminAbstractView, ConfigDelegate, Constants, EventManager, inlineScriptEditor, ScriptDelegate, LinkQualifierUtils) {
    ...
    var LinkQualifiersView = MappingAdminAbstractView.extend({
        ...
        populateScriptLinkQualifier: function populateScriptLinkQualifier(data) {
            if (_.isArray(data) === true) {
                _.each(data, function (linkQualifier) {
                    this.$el.find("#scriptLinkQualifierList").append('<button disabled="true" type="button" class="removeLinkQualifier btn btn-primary">' + '<span class="linkQualifier">' + linkQualifier + '</span>' + '</button>');
                }, this);
        ...
        removeLinkQualifier: function removeLinkQualifier(e) {
            e.preventDefault();
        ...
        addLinkQualifier: function addLinkQualifier(e) {
            e.preventDefault();
            ...
            if (this.isValid(toAdd) && toAdd.length > 0) {
                ...
                this.$el.find("#staticLinkQualifierList").append('<button type="button" class="removeLinkQualifier btn btn-primary">' + '<span class="linkQualifier">' + toAdd + '</span>' + '<i class="fa fa-times fa-lg"></i>' + '</button>');
        ...
        isValid: function isValid(toAdd) {
