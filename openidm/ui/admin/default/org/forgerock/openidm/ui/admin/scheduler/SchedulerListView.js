...
define(["jquery", "lodash", "handlebars", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/scheduler/SchedulerCollection", "org/forgerock/openidm/ui/admin/delegates/ConnectorDelegate", "org/forgerock/openidm/ui/admin/util/AdminUtils", "backgrid", "org/forgerock/openidm/ui/common/util/BackgridUtils", "org/forgerock/openidm/ui/admin/util/Scheduler", "org/forgerock/openidm/ui/admin/util/SchedulerUtils", "backgrid-paginator"], function ($, _, handlebars, AdminAbstractView, eventManager, constants, SchedulerCollection, ConnectorDelegate, AdminUtils, Backgrid, BackgridUtils, scheduler, SchedulerUtils) {
    var SchedulerListView = AdminAbstractView.extend({
        ...
        getQueryFilterString: function getQueryFilterString(filters, connectors) {
            var queryFilter = "persisted eq true and schedule pr",
