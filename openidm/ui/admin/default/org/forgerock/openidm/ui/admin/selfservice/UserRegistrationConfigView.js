...
define(["jquery", "backbone", "lodash", "handlebars", "form2js", "backgrid", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/admin/authentication/AuthenticationAbstractView", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/openidm/ui/admin/delegates/SiteConfigurationDelegate", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/util/AdminUtils", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/selfservice/SelfServiceStageDialogView", "org/forgerock/openidm/ui/admin/selfservice/SelfServiceUtils", "org/forgerock/openidm/ui/common/delegates/SocialDelegate", "org/forgerock/openidm/ui/admin/mapping/properties/AttributesGridView", "org/forgerock/openidm/ui/common/util/BackgridUtils", "selectize", "bootstrap-tabdrop"], function ($, Backbone, _, Handlebars, form2js, Backgrid, AdminAbstractView, AuthenticationAbstractView, ConfigDelegate, SiteConfigurationDelegate, UiUtils, AdminUtils, EventManager, Constants, SelfServiceStageDialogView, SelfServiceUtils, SocialDelegate, AttributesGridView, BackgridUtils) {
    ...
    var UserRegistrationConfigView = AdminAbstractView.extend({
        ...
        partials: ["partials/providers/_providerCircle.html", "partials/providers/_providerBadge.html", "partials/_toggleIconBlock.html", "partials/selfservice/_registrationFormCell.html"],
        model: {
        ...
        render: function render(args, callback) {
            ...
            $.when(this.getResources(), ConfigDelegate.readEntity("selfservice.propertymap"), ConfigDelegate.readEntity("ui/configuration"), ConfigDelegate.readEntityAlways(this.model.configUrl), ConfigDelegate.readEntityAlways("external.email"), ConfigDelegate.readEntityAlways("consent"), ConfigDelegate.readEntity("managed"), SocialDelegate.providerList()).then(_.bind(function (resources, propertyMap, uiConfig, selfServiceConfig, emailConfig, consentConfig, managedConfig, availableProviders) {
        ...
        openRegistrationDetails: function openRegistrationDetails(event) {
            var _this5 = this;
            ...
            AdminUtils.findPropertiesList(details.identityServiceUrl.split("/")).then(function (properties) {
                ...
                _this5.loadSelfServiceDialog(_.noop(), "idmUserDetails", details);
            });
        },
        loadSelfServiceDialog: function loadSelfServiceDialog(el, type, data) {
            var _this6 = this;
            ...
            SelfServiceStageDialogView.render({
                ...
                "saveCallback": function saveCallback(config, oldData) {
                    _.extend(_this6.model.saveConfig.stageConfigs, config.stageConfigs);

                    if (config.snapshotToken) {
                        _.extend(_this6.model.saveConfig.snapshotToken, config.snapshotToken);
                    }

                    _this6.saveConfig(_this6.model.saveConfig, oldData);
                },
        ...
        controlAllSwitch: function controlAllSwitch(event) {
            ...
            if (this.data.enableSelfService) {
                ...
                this.createConfig().then(function () {
                    EventManager.sendEvent(Constants.EVENT_DISPLAY_MESSAGE_REQUEST, _this7.model.msgType + "Save");

                    if (_this7.data.socialProviders.providerList.length > 0) {
                        _this7.$el.find("#social .section-check").prop("checked", true).trigger("change");
                    }

                    _this7.openRegistrationDetails();
                });
            } else {
                this.$el.find("#userRegistrationConfigBody").hide();
                ...
                if (!this.model.surpressSave) {
                    ...
                    if (cardDetails.type !== "socialUserDetails") {
                        ...
                        this.updateAutoLoginConfigToCurrentAuthenticationMethod(this.setSuccessUrl(this.model.configAccountClaimDefault, this.getSuccessUrl())).then(function (updatedConfig) {
                            _this8.model.configAccountClaimDefault = updatedConfig;
                            return ConfigDelegate.createEntity(_this8.model.accountClaimUrl, updatedConfig);
                        });
                    }
                }
            } else {
        ...
        setKBADefinitionEnabled: function setKBADefinitionEnabled() {
        ...
        createConfig: function createConfig() {
            ...
            return this.updateAutoLoginConfigToCurrentAuthenticationMethod(this.model.saveConfig).then(function (updatedConfig) {
                ...
                return $.when(ConfigDelegate.createEntity(_this9.model.configUrl, updatedConfig), ConfigDelegate.updateEntity("ui/configuration", _this9.model.uiConfig));
            }).then(function () {
        ...
        saveConfig: function saveConfig(config, oldData) {
            var _this10 = this;
            ...
            return this.updateAutoLoginConfigToCurrentAuthenticationMethod(saveData).then(function (updatedConfig) {
                _this10.model.saveConfig = updatedConfig;
                return $.when(ConfigDelegate.updateEntity(_this10.model.configUrl, updatedConfig), ConfigDelegate.updateEntity("ui/configuration", _this10.model.uiConfig));
            }).then(function () {
                if (localAutoLoginIndex !== -1 && _this10.model.saveConfig.stageConfigs[idmUserDetailsIndex].socialRegistrationEnabled) {

                    return _this10.updateAutoLoginConfigToCurrentAuthenticationMethod(_this10.setSuccessUrl(_this10.model.configAccountClaimDefault, _this10.getSuccessUrl())).then(function (updatedConfig) {
                        if (!_.isEqual(_this10.model.configAccountClaimDefault, updatedConfig)) {
                            _this10.model.configAccountClaimDefault = updatedConfig;
                            return ConfigDelegate.updateEntity(_this10.model.accountClaimUrl, updatedConfig);
                        }
                    });
                }
            }).then(function () {
                ...
                EventManager.sendEvent(Constants.EVENT_DISPLAY_MESSAGE_REQUEST, _this10.model.msgType + "Save");
