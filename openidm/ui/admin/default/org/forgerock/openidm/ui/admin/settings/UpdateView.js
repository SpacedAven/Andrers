...
define(["jquery", "underscore", "backgrid", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/AbstractModel", "org/forgerock/commons/ui/common/main/AbstractCollection", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/settings/update/VersionsView", "org/forgerock/openidm/ui/admin/settings/update/HistoryView", "org/forgerock/openidm/ui/admin/settings/update/InstallationPreviewView", "org/forgerock/openidm/ui/admin/settings/update/MaintenanceModeView", "org/forgerock/openidm/ui/admin/settings/update/InstallView", "org/forgerock/openidm/ui/admin/settings/update/InstallationReportView", "org/forgerock/openidm/ui/admin/settings/update/RepoUpdateView", "org/forgerock/openidm/ui/admin/delegates/MaintenanceDelegate"], function ($, _, Backgrid, AdminAbstractView, AbstractModel, AbstractCollection, Constants, VersionsView, HistoryView, InstallationPreviewView, MaintenanceModeView, InstallView, InstallationReportView, RepoUpdateView, MaintenanceDelegate) {
                ...
                switch (args.step) {
                    ...
                    case "version":
                        MaintenanceDelegate.getStatus().then(_.bind(function (maintenanceData) {
                            MaintenanceDelegate.getUpdateLogs({ excludeFields: ['files'] }).then(_.bind(function (updateLogData) {
