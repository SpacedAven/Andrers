...
define(["jquery", "underscore", "org/forgerock/openidm/ui/admin/settings/audit/AuditAdminAbstractView", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openidm/ui/admin/util/InlineScriptEditor", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/ValidatorsManager", "bootstrap-dialog", "jsonEditor", "bootstrap-tabdrop"], function ($, _, AuditAdminAbstractView, uiUtils, conf, InlineScriptEditor, constants, ValidatorsManager, BootstrapDialog, JSONEditor) {
    ...
    var AuditTopicsDialog = AuditAdminAbstractView.extend({
        ...
        updateWatchedFields: function updateWatchedFields(e) {
            this.data.defaults.event.watchedFields = this.$el.find(".watchedFields").val();
        },

        updatePasswordFields: function updatePasswordFields(e) {
