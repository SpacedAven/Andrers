...
define(["jquery", "lodash", "handlebars", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/openidm/ui/common/resource/GenericEditResourceView", "org/forgerock/commons/ui/common/main/ValidatorsManager", "org/forgerock/openidm/ui/admin/role/MembersView", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/openidm/ui/common/delegates/ResourceDelegate", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants"], function ($, _, Handlebars, AbstractView, GenericEditResourceView, ValidatorsManager, MembersView, ConfigDelegate, ResourceDelegate, EventManager, Constants) {
    ...
    EditUserView.prototype.addResetPasswordButton = function () {
        ...
        this.$el.find("#passwordSaveBtn").before(this.configureResetPasswordButton(el));
    };
    ...
    EditUserView.prototype.getFormValue = function () {
        ...
        if (ValidatorsManager.formValidated(this.$el.find("#password")) && passwordText && passwordText.length) {
            return _.extend({ "password": passwordText }, GenericEditResourceView.getFormValue.call(this));
        } else {
