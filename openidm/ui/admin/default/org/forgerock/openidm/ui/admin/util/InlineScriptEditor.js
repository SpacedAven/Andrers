...
define(["jquery", "underscore", "jsonEditor", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/ValidatorsManager", "libs/codemirror/lib/codemirror", "libs/codemirror/mode/groovy/groovy", "libs/codemirror/mode/javascript/javascript", "libs/codemirror/addon/display/placeholder", "org/forgerock/openidm/ui/common/delegates/ScriptDelegate", "org/forgerock/openidm/ui/admin/util/WorkflowWidget"], function ($, _, JSONEditor, AbstractView, validatorsManager, codeMirror, groovyMode, jsMode, placeHolder, ScriptDelegate, WorkflowWidget) {
    var seInstance = {},
        ...
        render: function render(args, callback) {
            ...
            this.parentRender(_.bind(function () {
                var mode, workflowName, workflowParams, currentScriptSelection;
        ...
        changeScriptTab: function changeScriptTab(event) {
        ...
        saveEvent: function saveEvent(callback, cm, changeObject) {
            this.cmBox.save();
        ...
        localScriptChange: function localScriptChange(event) {
        ...
        passedVariableBlur: function passedVariableBlur() {
        ...
        changeRenderMode: function changeRenderMode(event) {
        ...
        scriptSelect: function scriptSelect(event, codeMirror) {
        ...
        setSelectedScript: function setSelectedScript(disabledScript, enabledScript) {
        ...
        addEmptyPassedVariable: function addEmptyPassedVariable() {
            this.addPassedVariable(null, null);
        },

        addPassedVariable: function addPassedVariable(name, value) {
            var field, editor;
        ...
        deletePassedVariable: function deletePassedVariable(event) {
            event.preventDefault();
