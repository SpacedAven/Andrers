...
define(["jquery", "underscore", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/util/ModuleLoader", "org/forgerock/openidm/ui/common/delegates/ResourceDelegate", "org/forgerock/commons/ui/common/main/AbstractModel", "org/forgerock/commons/ui/common/main/AbstractCollection", "org/forgerock/openidm/ui/common/util/BackgridUtils", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openidm/ui/admin/util/WorkflowUtils", "backgrid"], function ($, _, AdminAbstractView, ModuleLoader, ResourceDelegate, AbstractModel, AbstractCollection, CustomCells, EventManager, Constants, Router, WorkflowUtils, Backgrid) {
    ...
    var TaskListView = AdminAbstractView.extend({
        ...
        assignTask: function assignTask(e) {
            if (e) {
                e.preventDefault();
            }
